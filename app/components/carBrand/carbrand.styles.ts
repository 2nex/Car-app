...
export const createStyles = (isHorizontal : boolean| undefined, isSelected : boolean | undefined) =>
  StyleSheet.create({
    ...
    brandContainer: {
      ...
      columnGap: isHorizontal?  scale(4) : scale(0),
    ...
    brand: {
      ...
      height: isHorizontal ? scale(40) : scale(50),
      width: isHorizontal ? scale(40) : scale(50),
      alignItems: 'center',
    ...
    brandText : {
      ...
      marginRight: isHorizontal ? scale(6) : scale(0),
    },
    brandImage : {
